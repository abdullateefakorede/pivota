...
describe('Voter Route Test', () => {
	test('', () => {
		...
		expect(mockRouter.post).toHaveBeenNthCalledWith(1, '/signin', expect.any(Function));
		expect(mockRouter.post).toHaveBeenNthCalledWith(2, '/signup', expect.any(Function));
